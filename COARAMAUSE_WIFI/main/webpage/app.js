// < COARAMAUS ACCESS-POINT INTERFACE >
...
// USING INTERMEDIATE-INVOKED FUNCTION EXPRESSION STYLE
...
// --------------------
// < DISPLAYING SCENE >
// (BROADCAST TO EVERY OTHER UNITS)
function setupButtons() {
	...
	// 	console.log("CURSOR IS HOVERING ON BUTTON");
	// 	console.log($(this).val());


	// 	// // GETTING VALUE (SCENE NUMBER WE WANT TO DISPLAY)
	// 	// // FROM BUTTON
	// 	// var btnPressedNum = $(this).val();
	...
	// 	// 		console.log("RESPONSED FROM SERVER :: ");
	// 	// 		console.log(response);

	// 	// 		// if(data.result === "OK") {
	// 	// 		// 	console.log("RESPONSED FROM SERVER :: SENDING WAS OK");
	// 	// 		// } else {
	// 	// 		// 	console.log("RESPONSED FROM SERVER :: SENDING WAS NOT OK");
	// 	// 		// }
	// 	// 	}
	// 	// });
	...
	$("button").click( function() {
		...
		console.log("CLIENT SIDE :: displayScene() FUNCTION EXECUTED");
