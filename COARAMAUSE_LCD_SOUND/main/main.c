...
static QueueHandle_t s_qhnd_i2sSound_pngSlide;
...
// I (289) heap_init: At 3FF80000 len 00002000 (8 KiB): RTCRAM
// I (295) heap_init: At 3FFAE6E0 len 00001920 (6 KiB): DRAM
// I (301) heap_init: At 3FFB2D80 len 0002D280 (180 KiB): DRAM
// I (308) heap_init: At 3FFE0440 len 0001FBC0 (126 KiB): D/IRAM
// I (314) heap_init: At 40078000 len 00008000 (32 KiB): IRAM
// I (320) heap_init: At 4008DB0C len 000124F4 (73 KiB): IRAM
...
static void checkHeap() {
    ...
    printf("===================================================\r\n");
    printf("MEMORY CHECKING REMAINED     ::     MAIN      ::  %d\r\n", gHEAPMEMORY_REMAINED);
...
void app_main(void) {
    ...
    s_qhnd_i2sSound_pngSlide = xQueueCreate(5, sizeof(i2sSound_QMsg_t) );
    ...
    // -----------------------------------
    // INITIALIZING I2SSOUND
    ESP_LOGI(TAG, "-----------------------------");
    ESP_LOGI(TAG, "-----------------------------");
    ESP_LOGI(TAG, "Initializing I2SSOUND");

    i2sSound_Init(&s_qhnd_i2sSound_pngSlide);
    ...
    // malloc() IS DANGEROUS !!!!!!!!!!!
    // UN-INITIALIZED MEMORY AREA IS DANGEROUS TO USE !!!!!!
    // 
    // WHEN I CHANGED BELOW TO calloc SUDDENLY IT WAS FIXED PROPERLY !!!!
    //
    pngSlideInstance = calloc(1, sizeof(PngSlide_t));
    pngSlideInstance = PngSlideStart( pngSlideInstance, 0, &s_qhnd_i2sSound_pngSlide);
    ...
    PngSlide_Task_Play_Start(pngSlideInstance, 8, 2, tskNO_AFFINITY);





    checkHeap();           // 9 KiB SAME AS ABOVE
